                        ...
                        <template slot-scope="{ row, user }">
                            ...
                            <td class="px-4 py-2 grid-cols-2 gap-x-4 inline-flex">
                                <div v-if="$page.user.is_admin">
                                    <inertia-link :href="$route('expenses.edit', row.id)">
                                ...
                                <a :href="$route('expenses.show', row.id)" target="_new">
...
export default {
    ...
    computed: {
        rowfilter: function() {
            ...
            return this.$page.expenses.data.filter(row => {
